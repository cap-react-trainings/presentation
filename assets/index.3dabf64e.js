...
`,Y=`const Book: FC = ({name="Tom", author="Rowling"}: Book) => {
return (
  <div>
    <h1>{name}</h1>
    <p>author: {author}</p>
  ...
  props.title = "HI"
}`,X=`const Book: React.FC = ({ name, author }: Book) => {
  return (
    <div>
...
`,K=`const Book: React.FC = ({ name, author }: Book) => {
  return (
    <div>
      <h1 className='myHeadline'>{name}</h1>
...
}`,ce=`const AuthenticationComponent: React.FC = (props: Props) => {
  let button;
  if (props.userName) {
    button = <LogoutButton />
  } else {
...
`,de=`const UsersList: React.FC = (props: Props) => {
...
}`,ue=o=>t(d,c(l({},o),{subtitle:t("ul",{children:[e("li",{children:"rendering different components"}),e("li",{children:"inline conditions"})]}),children:[t(r,{children:[e("h2",{children:"Component uses different return statements"}),e(n,{className:"fragment",children:se})]}),t(r,{children:[e("h2",{children:"Conditionally assign component to variable"}),t("div",{className:"fragment",children:[e(n,{className:"",children:ae}),e(n,{className:"",children:le})]}),e(n,{className:"fragment",children:ce})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 1"}),e(n,{className:"fragment",children:de})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 2"}),e(n,{className:"fragment",children:he})]}),t(r,{children:[e("h2",{children:"Prevent component from rendering"}),e(n,{className:"fragment",children:me})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Extend your Book-Component with a badge that notifies the user when a book is not available in store. (Pass an additional prop to your Book-Component)."}),e("li",{children:"Bear in mind that there might be a case where no books are available for rendering. Create a UI for that."})]})]})]})),pe=`// fetch user...
...
`,ye=`const {theme, toggleTheme} = useContext(UserContext)
...
`,Se="const { loading, books } = useBooks()",Ce=`const fetchUsers = async () => {
...
`,Me=`const { register, handleSubmit, errors } = useForm<MyForm>();
...
`,Le=o=>t(d,c(l({},o),{children:[t(r,{children:[t("p",{children:["More of a personal preference,",e("br",{}),"but there are a few popular libs:"]}),t("ul",{className:"fragment",children:[t("li",{children:[e("a",{href:"https://github.com/jaredpalmer/formik",target:"_blank",rel:"noreferrer",children:"Formik"}),e("div",{children:e("small",{children:"(31k stars on github)"})})]}),t("li",{children:[e("a",{href:"https://github.com/react-hook-form/react-hook-form",target:"_blank",rel:"noreferrer",children:"React Hook Form"}),e("div",{children:e("small",{children:"(32k stars on github)"})})]})]}),e("aside",{className:"notes",children:"Depends on personal preference, used UI libs/frameworks and performance requirements."})]}),e(r,{children:t("div",{children:["Components based",e(n,{children:He})]})}),t(r,{children:[t("div",{children:["Hooks based",e(n,{children:Me})]}),e("aside",{className:"notes",children:"Better performance wise. Just updates necessary children."})]}),t(r,{children:[e("h2",{children:"Further Reads"}),e("ul",{children:e("li",{children:e("a",{href:"https://dev.to/pmbanugo/looking-for-the-best-react-form-library-in-2021-it-s-probably-on-this-list-e2h",target:"_blank",rel:"noreferrer",children:"\u{1F4C4} Comparison of four form libraries"})})})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:e("code",{children:"git checkout 05-routing-chapter"})}),e("li",{children:"extend your booklist with the possibility to add a new book to your list. (For example, add some button that shows a form onClick())"}),t("li",{children:["install"," ",e("a",{href:"https://react-hook-form.com/api/useform/",target:"_blank",rel:"noreferrer",children:"react-hook-form"})]}),t("li",{children:["In case you're finished early: try to use"," ",e("a",{href:"https://formik.org/docs/overview",target:"_blank",rel:"noreferrer",children:"Formik"})," ","\u{1F913}"]})]})]})]})),Ee=`import { createRoot } from "react-dom/client";

const rootElement = document.getElementById("root");
const root = createRoot(rootElement);

root.render(<div>Hi</div>);
`,Pe=`import { createRoot } from "react-dom/client";
...
`,je=`npx create-react-app my-app
# or better
...
`,_e=`const element = (
  ...
  `,Ue=o=>t(d,c(l({},o),{subtitle:e("p",{children:"Minimal App, Bootstrapping & Templating"}),children:[t(r,{children:[e("h2",{children:"Minimal App"}),e(n,{className:"fragment",children:Ee})]}),t(r,{children:[e("h2",{children:"Bootstrapping a Project"}),e(n,{className:"fragment",language:"bash",children:je})]}),t(r,{children:[e("h2",{children:"Templating with JSX / TSX"}),e("p",{className:"fragment",children:"syntax extension to JavaScript"}),e("p",{className:"fragment",children:"describe what the UI looks like"}),e("p",{className:"fragment",children:"full power of JavaScript"}),e("p",{className:"fragment",children:"produces React elements"}),e("p",{className:"fragment",children:"TSX enhances JSX in terms of type checking"}),e(n,{className:"fragment",children:Ie})]}),t(r,{children:[e("h2",{children:"JSX / TSX Elements"}),t("ul",{className:"fragment",children:[e("li",{children:"elements are looked up by identifiers"}),e("li",{children:"naming convention starts with capital letter"}),e("li",{children:"You can import them as a component in your app"})]}),e(n,{className:"fragment",children:De}),e(n,{className:"fragment",children:Oe})]}),t(r,{children:[e("h2",{children:"JavaScript in Elements"}),e(n,{children:_e}),e("p",{children:"notice the following:"}),t("ul",{children:[t("li",{children:["JSX Elements can have mutlitple children but need ",e("b",{children:"one"})," root element"]}),t("li",{children:["empty tags may be closed immediatly with `","/>","`"]}),t("li",{children:["JavaScript can be used inside JSX (","{}",")"]})]})]}),t(r,{children:[e("h2",{children:"Minimal App with data"}),e(n,{children:Pe})]})]})),ze="<AddButton onClick={() => setIsAddOpen(true)} />",Je=`const moizedOpen = useCallback(() => {
    setIsAddOpen(true);
...
`,nt=o=>{const i=({id:s,pixel:m})=>e(r,{dataAutoAnimate:!0,children:t("div",{style:{position:"relative"},children:[e("img",{src:"./slide-assets/atomic-design-example.png"}),e("div",{"data-id":s,style:{position:"absolute",background:"#191919",height:"100%",width:"100%",top:0,marginLeft:m}})]})});return t(d,c(l({},o),{children:[e(r,{children:e("h2",{children:"Atomic Design"})}),[207,390,572,755,979].map(s=>e(i,{id:"hi",pixel:s},s)),t(r,{children:[e("h2",{children:"Storybook"}),e("video",{autoPlay:!0,playsInline:!0,loop:!0,"data-autoplay":!0,children:e("source",{src:"https://storybook.js.org/cdb19b23da5e96c112ff3b8fded28a82/storybook-hero-video-optimized-lg.mp4",type:"video/mp4"})})]}),t(r,{children:[e("h2",{children:"Why you should use it"}),t("ul",{children:[e("li",{className:"fragment",children:"faster and easier development (isolation)"}),e("li",{className:"fragment",children:"better awareness about components"}),e("li",{className:"fragment",children:"easier to test edge cases"}),e("li",{className:"fragment",children:"better documentation"})]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{highlightedLines:"5,13",children:rt})]}),t(r,{children:[e("h2",{children:"How to Storybook"}),t("p",{children:[e("a",{href:"https://storybook.js.org/tutorials/intro-to-storybook/react/en/get-started/",children:"1. \u{1F3D7} Set it up from scratch"}),e(n,{children:"npx degit chromaui/intro-storybook-react-template newproject"})]}),t("p",{children:[e("a",{href:"https://storybook.js.org/docs/react/get-started/install",children:"2. \u{1F4E6} Set it up in an existing project"}),e(n,{children:"npx storybook init"})]})]}),t(r,{children:[e("h2",{children:"Addons"}),e("img",{src:"./slide-assets/storybook-a11y-plugin.png"})]}),t(r,{children:[e("h2",{children:"Component library"}),e("img",{src:"./slide-assets/component-lib-approach.png"})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://storybook.js.org/docs/react/get-started/introduction",target:"_blank",rel:"noreferrer",children:"Storybook Docs"})}),e("li",{children:e("a",{href:"https://bradfrost.com/blog/post/atomic-web-design/",target:"_blank",rel:"noreferrer",children:"Atomic Design"})}),e("li",{children:e("a",{href:"https://bradfrost.com/blog/post/atomic-design-and-storybook/",target:"_blank",rel:"noreferrer",children:"Atomic Design & Storybook"})})]})]})]}))},ot=`test("loads and displays book list", async () => {
    render(<BookOverview />);
...
...`,mt=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{className:"fragment",children:ot})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{className:"fragment",children:it})]}),t(r,{children:[e("h2",{children:"API Mocking with MSW"}),e("p",{children:'"Mock service worker"'}),e(n,{className:"fragment",children:st}),e(n,{className:"fragment",children:at})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})})]})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 06-forms-chapter"}),e("p",{children:"Setup for testing"}),e(n,{language:"bash",children:lt}),e(n,{language:"bash",children:ct})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Create / modify files"}),e(n,{language:"bash",children:dt}),e(n,{language:"bash",children:ht})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const b=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const ut={plugins:[C],slideNumber:!0,history:!0},pt=o=>(p.exports.useEffect(()=>{new S(ut).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),gt=()=>{const o=[{title:"Comparison of Frameworks",component:J},{title:"React in a nutshell \u{1F95C}",component:Ue},{title:"Components & Styling",component:ie},{title:"Conditional Rendering",component:ue},{title:"Hooks & Databinding",component:Te},{title:"Context",component:ke},{title:"Routing",component:j},{title:"Forms",component:Le},{title:"Testing",component:mt},{title:"Atomic Design & Storybook",component:nt},{title:"Improving Performance",component:Ke},{title:"React Native",component:tt}];return t(pt,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(b,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(b,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),t(r,{isMain:!0,children:[e("h2",{children:"\u{1F64B}\u200D\u2640\uFE0F Who are you?"}),t("div",{style:{textAlign:"left",display:"inline-block"},children:["Let's get to know each other on"," ",e("a",{style:{color:"#F48FB1",textDecoration:"underline"},href:"https://app.mural.co/invitation/mural/dcx6016/1671440000180?sender=u67ac3f75ad329840b6034527&key=5ba8746e-9bf6-4976-b7b9-6979d859125d",children:"Mural"})]})]}),e(I,{chapter:o}),o.map((i,s)=>e(i.component,{title:i.title,index:s+1},s)),t(r,{isMain:!0,children:[e("h2",{children:"Thanks a lot!"}),e("p",{children:"Please fill out our survey, so that we can keep on improving! \u{1F60A}"})]})]})};B.render(e(A.StrictMode,{children:e(gt,{})}),document.getElementById("root"));
